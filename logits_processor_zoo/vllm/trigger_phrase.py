...
class TriggerPhraseLogitsProcessor:
    ...
    trigger_time (float): Time in seconds after which the phrase will be triggered.
    ...
    def clone(self):
        return TriggerPhraseLogitsProcessor(
            self.tokenizer,
            self.phrase,
            self.trigger_token_phrase,
            self.trigger_time,
            self.initial_trigger_count,
            self.trigger_after,
        )
